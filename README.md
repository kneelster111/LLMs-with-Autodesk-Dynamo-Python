...
1. **Run the Dynamo script** to install required custom modules - [PY - InstallCustomPythonModules.dyn ](https://github.com/kneelster111/LLMs-with-Autodesk-Dynamo-Python/blob/main/GPT4all_DynamoScripts/PY%20-%20InstallCustomPythonModules.dyn)
